#!/usr/bin/env python3
"""TZ-02 als sprachneutrale Eingabe (02-golden-anchors.md §5)."""
...
from tests.trust.tz02 import Graph, PARAMS, iter_profiles

VECTORS_PATH = ROOT / "tests" / "vectors" / "vectors_02_tz02.json"
...
def build_profiles() -> list[dict[str, object]]:
    """Z1–Z9 — Reihenfolge und Werte aus tz02.py."""
